 ...
 */
public class UsersAdapter_ListView extends ArrayAdapter<User_ListView> {
    public UsersAdapter_ListView(Context context, ArrayList<User_ListView> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        User_ListView user = getItem(position);
