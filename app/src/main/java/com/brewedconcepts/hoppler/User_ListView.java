...
public class User_ListView {
    ...
    public User_ListView(String house_address, String house_sqm, String house_br, String house_ba, String house_id, String house_price) {
